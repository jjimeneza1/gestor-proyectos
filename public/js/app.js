 ...
 * ================================================================
 */
alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].data('crudApp', function () {
  return {
    // -----------------------------------------------------------------
    // Estado del sidebar
     ...
     *   </button>
     */
    confirmDelete: function confirmDelete(action) {
      var name = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
      var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'danger';
      this.modal = {
        show: true,
        title: 'Confirmar eliminación',
        message: name ? "\xBFEst\xE1s seguro de que deseas eliminar \"".concat(name, "\"? Esta acci\xF3n no se puede deshacer.") : '¿Estás seguro de que deseas eliminar este registro? Esta acción no se puede deshacer.',
        action: action,
        type: type
      };
    },
